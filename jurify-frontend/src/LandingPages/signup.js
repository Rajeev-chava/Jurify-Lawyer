...
const Signup = () => {
    ...
    const loginHandler = async (event) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/clients/login`, {
    ...
    const signupHandler = async (event) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/clients/register`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (data.message === 'success') {
                ...
                setIsActive(!isActive); // Switch to login panel
            } else {
