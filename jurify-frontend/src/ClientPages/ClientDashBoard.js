        ...
        >
          <div className="flex items-center justify-between h-16 px-4 bg-gray-900">
            <span className="text-xl font-semibold text-white capitalize">
              ...
              <button className='absolute z-[999] left-[50vw] sm:left-[15vw]' onClick={toggleSidebar}>
                <FaArrowAltCircleLeft />
              </button>
            </span>
          </div>
          <div className="px-4 py-6 text-white space-y-2">
            <button onClick={() => changeContent('Home')} className="block w-full text-left py-2 uppercase font-bold hover:underline">
              Home
            </button>
            <button onClick={() => changeContent('Appointments')} className="block w-full text-left py-2 uppercase font-bold hover:underline">
              Appointments
            </button>
            <button onClick={() => changeContent('updates')} className="block w-full text-left py-2 uppercase font-bold hover:underline">
              Updates
            </button>
            {/* Uncomment this if needed */}
            {/* <button onClick={() => changeContent('Settings')} className="block w-full text-left py-2 uppercase font-bold hover:underline">
              Settings
            </button> */}
          </div>
        </nav>
